<?php session_start(); 
if($forcast = $_GET['FORCAST_HAR']){
    $forcast_har = $_GET['FORCAST_HAR'];
}
else{
    echo header('Location:hasil.php');
}
                ...
                <div class="card-body card mt-4">
                    <table class="table table-borderless datatable">
                      ...
                      <tbody>
                          ...
                          error_reporting(0);
                          $forcast_har = $_GET['FORCAST_HAR'];
                          $result = mysqli_query($conn, "SELECT * FROM HARIAN WHERE FORCAST_HAR = '$forcast_har'");
                          ...
                          if (mysqli_num_rows($result) > 0) {
                              ...
                              $addTgl = date('Y-m-d', strtotime('+1 day', strtotime($tgl[(count($tgl)-1)])));
                    ...
                    <div class="row" style="text-align: center;">
                        ...
                        <div class=" col-6 card-body card mr-3 mt-4"><br>
                          <?php
                          $tgl_akh = mysqli_query ($conn, "SELECT * FROM HARIAN WHERE FORCAST_HAR = '$forcast_har' ORDER BY TGL_HAR DESC LIMIT 1");
                          ...
                          ?>
                            ...
                            <h5><?php 
                            // echo $tgl_terakhir;
                            echo date('Y-M-d', strtotime('+1 day', strtotime($tgl_terakhir)));
                            ?></h5>
              ...
              <div class="card card-body mt-4">
                        ...
                        <script src="https://cdn.jsdelivr.net/npm/chart.js"></script>
                            ...
                            <script>
                                ...
                                var prediksi = <?php echo json_encode($prediksi); ?>; // Konversi hasil prediksi menjadi format JSON
                                ...
                                var chart = new Chart(ctx, {
                                    type: 'line',
                                    data: {
                                        labels: tgl.slice(0), // Mulai dari data ke-3 sebagai label sumbu x
                                        datasets: [
                                            {
                                                label: 'Data Aktual',
                                            ...
                                            {
                                                label: 'Forecast',
                                                data: <?php echo json_encode($wma); ?>, // Menggunakan hasil prediksi sebagai data forecast
                                                borderColor: 'red',
                                                fill: false
                                            }
                                        ]
